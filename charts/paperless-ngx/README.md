...
![Version: 1.1.1](https://img.shields.io/badge/Version-1.1.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.20.10](https://img.shields.io/badge/AppVersion-2.20.10-informational?style=flat-square)
...
To enable Authentik SSO, set `paperless.authentik.enabled` to `true` and provide the required values:

- `clientId`: The client ID from Authentik application
- `clientSecret`: The client secret (stored securely in the secret)
- `applicationSlug`: The slug of the Authentik application
- `domain`: The domain of your Authentik instance (e.g., authentik.company)

Refer to the [Authentik documentation](https://integrations.goauthentik.io/documentation/paperless-ngx/) for setup details.
